  ...
  return (
    <section className="relative h-[85vh] min-h-[600px] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        {/* Search Bar */}
        <motion.div
          className="w-full max-w-2xl glass rounded-2xl p-2"
        ...
        >
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button className="px-6 py-3 bg-primary text-primary-foreground font-display text-sm font-semibold rounded-xl hover:brightness-110 transition-all glow-green">
              Buscar
            </button>
          </div>
        </motion.div>
